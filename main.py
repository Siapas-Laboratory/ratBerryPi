                          ########################################
#
# This code references code from 
...
def experimentMode():
    ...
    while expOption in [1, 2, 3]:
        ...
        if expOption == 1:
            ...
            exit
# CALLIBRATION MODE
def callibrationMode():
    print("\n\033[1;33;40mSTARTING CALLIBRATION MODE ...")


# # test code for calling function from another file 
# aa = calculateSteps(10, "microliters", "thick", "1/2")
# print(aa)
...
"""
Note to self: Rewrite this using argparse so it is cleaner
"""
